...
Util::CSVType Util::loadCsvFromString(const std::string& csvDataString, bool commentFlag, char divChar, const std::string& commentStartStr)
{
	std::vector<std::vector<std::string>> csvData{}; // csvの中身を格納

	std::stringstream ss(csvDataString);
